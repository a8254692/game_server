...
func Init() {
	//注册系统公共事件
	event.Register("ExecuteCommand", reflect.ValueOf(ExecuteCommand))
	...
	ConnectGame.Init(ipGameServer+":"+portGameServer, ConnectManager.ServerTypeLocal, network.ServerType_Game)
	ConnectManager.ConnectGame = ConnectGame
}
