...
import (
	...
	"BilliardServer/GateWsServer/logic"
...
func Start(args []string) {
	...
	ipServer := config.Section(serverName).Key("ip").String()
	...
	//启动服务
	cm := new(network.Ws_Manager)
	cm.InitServer("ws://"+ipServer+":"+portServer, network.ServerType_Gate)
